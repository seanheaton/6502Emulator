/** RORInstruction.java
 *  
 *  Instruction to perform a rotation of bits right
 */
...
public class RORInstruction extends Instruction {
	 ...
	 * @param op
	 */
	public RORInstruction(Integer code) {
		this.opCode = code;
		this.operand = null;
		
		/**
		 * Use the opcode to find the specific ROR mode to
	...
	public void execute() throws Exception {
		...
		// set the 7th bit to old value of carry bit
