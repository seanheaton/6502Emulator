/** INCInstruction.java
 *  
 *  Instruction to add 1 to the value held at a specified memory location
 */
...
public class INCInstruction extends Instruction {
	 ...
	 * @param op
	 */
	public INCInstruction(Integer code) {
		this.opCode = code;
		this.operand = null;
		
		/**
		 * Use the opcode to find the specific INC mode to
